  ...
  return (
    <div className="min-h-screen bg-gradient-night relative">
      ...
      <div className="relative z-10">
        ...
        <footer className="text-center py-4 pb-20 text-muted-foreground text-xs space-y-2">
          <p>تم التطوير من قبل المهندس أبو غيث</p>
          <div className="flex items-center justify-center gap-3" dir="ltr">
            <a href="https://wa.me/967778933521" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-400 transition-colors" aria-label="واتساب">
            ...
            <a href="https://t.me/+967778933521" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors" aria-label="تيليجرام">
            ...
            <a href="tel:+967778933521" className="text-primary hover:underline">+967 778 933 521</a>
          </div>
        </footer>
      </div>
    </div>
